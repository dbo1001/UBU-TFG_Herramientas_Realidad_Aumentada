...
En la tabla \ref{tablaComparacion} se puede observar una comparativa entre las principales funcionalidades de las herramientas.

\label{tablaComparacion}\tablaSmall{Comparativa herramientas AR}{l c c c c}{comparacionHerramientas}
{ \multicolumn{1}{l}{Herramientas} & MultiTarget & AR sin Marcador & Plataformas Compatibles & Licencia \\}{ 
	ArCore & X&X&Android& \\ 
	ArKit &X&X&iOS\\
	CoSpaces&X & & \\
	Metaverse &X&X& \\
