...
se trata de un SDK, con la capacidad de soportar AR con marcadores y sin la necesidad de marcadores. 
Posee soporte para APIs nativas, como ObjetiveC para iOS, Java para Android y Unity.
...
\imagen{marta_2}{Imagen perteneciente a la aplicacion M.A.R.T.A, que funciona con Kudan}
...
\subsection{8thWall}
Entorno de desarrollo, que se caracteriza porque da la posibilidad de ejecutar el proyecto desde el navegador web dándole permiso para usar la cámara del dispositivo, de forma que no haría falta instalarse ninguna aplicación.
