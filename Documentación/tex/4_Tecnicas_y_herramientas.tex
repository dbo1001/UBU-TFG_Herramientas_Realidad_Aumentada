...
\imagen{Memoria/cospaces2}{Imagen de mi plataforma de desarrollo de CoSpaces (Captura de pantalla).}
...
\imagen{Memoria/zapbox}{Imagen perteneciente a un kit de zapbox y un ZapCode~\cite{ZapStudio}.}
...
\imagenPeque{Memoria/marta_2}{Imagen perteneciente a la aplicación M.A.R.T.A~\cite{marta_app}.}
...
\imagen{Memoria/vuforia01}{Posibles marcadores de Vuforia}
...
\imagen{Memoria/TablaHerramientasAR}{Tabla comparativa herramientas AR}
